...
populate_row_obs_ab <- function(h_row) {
  ...
  #' [1,]    0 1 2 0 0
  #' make other positions `0`s for `obs_a` and make other positions `0`s `obs_b`
  #' obs_a = 0 1 0 0 0
  #' obs_b = 0 0 1 0 0
  if (sum(h_row) == 3) {
  ...
  #' [2,]    0 0 1 0 0
  #' make other positions `0`s for `obs_a` and make prior positions `0`s for `obs_b`
  #' obs_a = 0 0 1  0  0
  #' obs_b = 0 0 0 NA NA
  else if (sum(h_row) == 1) {
    h_row_1_idx <- which(h_row == 1)
  ...
  #' for `h_2` that looks like
  #' [3,]    0    0    2    0    0
  #' make subsequent positions `0`s for `obs_a` and make other positions `0`s for `obs_b`
  #' obs_a = NA NA 0 0 0
  #' obs_b =  0  0 1 0 0
  else if (sum(h_row) == 2) {
    h_row_2_idx <- which(h_row == 2)
